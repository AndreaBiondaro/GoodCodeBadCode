package it.addvalue.assignment.fundingraised;
...
public class FundingRaised {
    ...
    CSVReader reader =
        new CSVReader(
            new InputStreamReader(
                FundingRaised.class.getClassLoader().getResourceAsStream("startup_funding.csv")));
    String[] row = null;
  ...
  public static Map<String, String> findBy(Map<String, String> options)
      throws IOException, NoSuchEntryException, CsvValidationException {
    List<String[]> csvData = new ArrayList<String[]>();
    CSVReader reader =
        new CSVReader(
            new InputStreamReader(
